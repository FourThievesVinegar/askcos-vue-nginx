    ...
    <v-list nav v-model:opened="openGroups" color="primary">
      ...
      <v-list-group value="modules" no-action>
        <template v-slot:activator="{ props }">
          <v-list-item v-bind="props" prepend-icon="mdi-file-tree" title="Modules"></v-list-item>
        </template>
      ...
      <v-list-item prepend-icon="mdi-bug" title="Report a bug" value="starred"></v-list-item>
    </v-list>
  </v-navigation-drawer>
</template>
